...
async function convertAllImages() {
    ...
    for(const imagePath of argv._) {
        ...
        const cFileString = await convert(imagePath, { cf: colorFormat, outputFormat: outputMode, binaryFormat: ImageMode[BINARY_FORMAT_PREFIX + binaryFormat], swapEndian: argv.s, imageName: imageName, dith:argv.d });
